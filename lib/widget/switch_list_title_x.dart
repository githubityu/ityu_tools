...
/// [SwitchListTileX] itself but by the [Material] widget ancestor. In this
/// case, one can wrap a [Material] widget around the [SwitchListTileX], e.g.:
///
/// {@tool snippet}
/// ```dart
/// ColoredBox(
...
/// {@end-tool}
///
/// ## Performance considerations when wrapping [SwitchListTileX] with [Material]
///
/// Wrapping a large number of [SwitchListTileX]s individually with [Material]s
/// is expensive. Consider only wrapping the [SwitchListTileX]s that require it
/// or include a common [Material] ancestor where possible.
///
/// To show the [SwitchListTileX] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad}
...
///
/// {@tool dartpad}
/// This sample demonstrates how [SwitchListTileX] positions the switch widget
...
class SwitchListTileX extends StatelessWidget {
  ...
  const SwitchListTileX.adaptive({
    super.key,
    required this.value,
    required this.onChanged,
    this.activeColor,
  ...
  ///
  /// The [ListTile] will be focused when this [SwitchListTileX] requests focus,
  ...
  ///
  /// Insets a [SwitchListTileX]'s contents: its [title], [subtitle],
  ...
  /// If non-null, defines the background color when [SwitchListTileX.selected] is true.
  ...
  Widget build(BuildContext context) {
    ...
    switch (controlAffinity) {
      case ListTileControlAffinity.leading:
        leading = Transform.scale(scale: 0.7, child: control);
        trailing = secondary;
      case ListTileControlAffinity.trailing:
      case ListTileControlAffinity.platform:
        leading = secondary;
        trailing = Transform.scale(scale: 0.7, child: control);
    }
