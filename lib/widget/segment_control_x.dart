...
class CupertinoSegmentedControlX<T extends Object> extends StatefulWidget {
  ...
  /// The CupertinoSegmentedControlX will be placed inside this padding.
  ///
  /// Defaults to EdgeInsets.symmetric(horizontal: 16.0)
  final EdgeInsetsGeometry? padding;

  @override
  State<CupertinoSegmentedControlX<T>> createState() =>
      _SegmentedControlState<T>();
}

class _SegmentedControlState<T extends Object>
    extends State<CupertinoSegmentedControlX<T>>
    with TickerProviderStateMixin<CupertinoSegmentedControlX<T>> {
  T? _pressedKey;
  ...
  bool _updateColors() {
    ...
    final Color selectedTextColor =
        widget.selectedTextColor ?? CupertinoTheme.of(context).primaryColor;
  ...
  @override
  void didUpdateWidget(CupertinoSegmentedControlX<T> oldWidget) {
